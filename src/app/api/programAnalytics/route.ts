...
import { getProgramDownloadsByTimeGrouping } from "@/actions/omny"
...
export async function GET(request: NextRequest) {
  ...
  const analyticsData = await getProgramDownloadsByTimeGrouping(programId,startDate,endDate,interval, timezone)
